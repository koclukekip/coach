...
export const routes: Routes = [
  ...
  { path: 'student/conversations', title: 'Sohbet | Derece Kampüsü', canActivate: [studentGuard], loadComponent: () => import('./pages/student/student-conversations.component').then(m => m.StudentConversationsComponent) },
  { path: 'student/schedule', title: 'Takvim Planlama | Derece Kampüsü', canActivate: [studentGuard], loadComponent: () => import('./pages/student/student-schedule.component').then(m => m.StudentScheduleComponent) },
